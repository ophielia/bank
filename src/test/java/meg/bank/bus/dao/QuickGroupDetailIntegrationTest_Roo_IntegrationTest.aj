...
import meg.bank.bus.dao.QuickGroupDetailIntegrationTest;
...
privileged aspect QuickGroupDetailIntegrationTest_Roo_IntegrationTest {
    
    declare @type: QuickGroupDetailIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: QuickGroupDetailIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: QuickGroupDetailIntegrationTest: @Transactional;
    
    @Autowired
    QuickGroupDetailDataOnDemand QuickGroupDetailIntegrationTest.dod;
    
    @Autowired
    QuickGroupDetailRepository QuickGroupDetailIntegrationTest.quickGroupDetailRepository;
    
    @Test
    public void QuickGroupDetailIntegrationTest.testCount() {
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testFind() {
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to initialize correctly", dod.getRandomQuickGroupDetail());
        long count = quickGroupDetailRepository.count();
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to initialize correctly", dod.getRandomQuickGroupDetail());
        long count = quickGroupDetailRepository.count();
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testFlush() {
        QuickGroupDetail obj = dod.getRandomQuickGroupDetail();
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to provide an identifier", id);
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testSaveUpdate() {
        QuickGroupDetail obj = dod.getRandomQuickGroupDetail();
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to provide an identifier", id);
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to initialize correctly", dod.getRandomQuickGroupDetail());
    ...
    @Test
    public void QuickGroupDetailIntegrationTest.testDelete() {
        QuickGroupDetail obj = dod.getRandomQuickGroupDetail();
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'QuickGroupDetail' failed to provide an identifier", id);
