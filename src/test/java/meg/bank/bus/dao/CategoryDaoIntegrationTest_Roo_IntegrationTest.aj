...
import meg.bank.bus.dao.CategoryDaoIntegrationTest;
...
privileged aspect CategoryDaoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: CategoryDaoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: CategoryDaoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: CategoryDaoIntegrationTest: @Transactional;
    
    @Autowired
    CategoryDaoDataOnDemand CategoryDaoIntegrationTest.dod;
    
    @Autowired
    CategoryRepository CategoryDaoIntegrationTest.categoryRepository;
    
    @Test
    public void CategoryDaoIntegrationTest.testCount() {
    ...
    @Test
    public void CategoryDaoIntegrationTest.testFind() {
    ...
    @Test
    public void CategoryDaoIntegrationTest.testFindAll() {
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to initialize correctly", dod.getRandomCategoryDao());
        long count = categoryRepository.count();
    ...
    @Test
    public void CategoryDaoIntegrationTest.testFindEntries() {
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to initialize correctly", dod.getRandomCategoryDao());
        long count = categoryRepository.count();
    ...
    @Test
    public void CategoryDaoIntegrationTest.testFlush() {
        CategoryDao obj = dod.getRandomCategoryDao();
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to provide an identifier", id);
    ...
    @Test
    public void CategoryDaoIntegrationTest.testSaveUpdate() {
        CategoryDao obj = dod.getRandomCategoryDao();
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to provide an identifier", id);
    ...
    @Test
    public void CategoryDaoIntegrationTest.testSave() {
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to initialize correctly", dod.getRandomCategoryDao());
    ...
    @Test
    public void CategoryDaoIntegrationTest.testDelete() {
        CategoryDao obj = dod.getRandomCategoryDao();
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CategoryDao' failed to provide an identifier", id);
