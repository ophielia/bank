...
public class QuickGroupController {
    ...
    @RequestMapping(value="/create",params="transid", method = RequestMethod.GET, produces = "text/html")
    public String createFromBankTrans(@RequestParam("transid") Long transid,  Model uiModel,HttpServletRequest httpServletRequest) {
    	// service call to create from banktrans / expensedetails
